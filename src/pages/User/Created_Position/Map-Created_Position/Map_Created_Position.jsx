...
//   const { setCreatedOrigin, setCreatedDestination } = usePosition();
...
//     if (searchType === "origin") {
//       setCreatedOrigin({ position, address }); // เก็บข้อมูลต้นทาง
//     } else if (searchType === "destination") {
//       setCreatedDestination({ position, address }); // เก็บข้อมูลปลายทาง
//     }
  
//     alert("ตำแหน่งถูกบันทึกแล้ว");
//     navigate("/created_position"); // กลับไปหน้าที่แสดงข้อมูลที่สร้าง

//     // setCreatedPosition(position); // เก็บตำแหน่งเฉพาะหน้านี้
//     //     alert("ตำแหน่งถูกบันทึกแล้ว");
//     };
